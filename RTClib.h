...
public:
	...
	void setYear(int newYear)      { yOff = newYear - 2000; }
    void setMonth(uint8_t newMonth)       { m = newMonth; }
    void setDay(uint8_t newDay)          { d = newDay; }
    void setHour(uint8_t newHour)       { hh = newHour; }
    void setMinute(uint8_t newMinute)     { mm = newMinute; }
    void setSecond(uint8_t newSecond)       { ss = newSecond; }
